...
{
    public partial class PayUpdates : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageSeenInfoEnumId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BillTypeEnumId = table.Column<int>(type: "int", nullable: false),
                    MonthOfBill = table.Column<int>(type: "int", nullable: false),
                    BillAmount = table.Column<double>(type: "float", nullable: false),
                    ApartmentId = table.Column<int>(type: "int", nullable: false),
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    BillMonthEnum = table.Column<int>(type: "int", nullable: false),
                    BillTypeEnum = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidentTypeEnumId = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhoneNumber_NationalIdentificationNo_UserId_ApartmentId",
                table: "Residents",
                columns: new[] { "PhoneNumber", "NationalIdentificationNo", "UserId", "ApartmentId" },
                unique: true);
